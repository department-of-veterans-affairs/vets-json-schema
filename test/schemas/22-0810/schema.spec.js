...
import schema from '../../../src/schemas/22-0810/schema';
...
describe('22-0810 schema', () => {
  ...
  validationHelper.testValidAndInvalid('examName', testData.examName);
  validationHelper.testValidAndInvalid('examDate', testData.examDate);
  validationHelper.testValidAndInvalid('examCost', testData.examCost);
...
describe('22-0810 schema test inputs', () => {
  const base = {
    examCost: 123,
    applicantName: {
      first: 'Joe',
    ...
    examName: 'Physics Certification',
    examDate: '2022-11-12',
    mailingAddress: {
      country: 'USA',
