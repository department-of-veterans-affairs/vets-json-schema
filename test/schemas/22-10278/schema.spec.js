...
securityQuestion: {
    valid: [
        {
            question: ['pin', 'motherBornLocation', 'highSchool', 'petName', 'teacherName', 'fatherMiddleName', 'create']
        }
    ],
    invalid: [
        {
            question: ['pinCode', "locationOfMotherBirth", "", null, "pets"],
        },
    ]
},
// securityAnswer: {
