const schema = {
  ...
  properties: {
    ...
    conditionsOfAppointment: {
      description:
        'If the individual named in Item 15A is an accredited agent or attorney, the scope of representation provided before VA may be limited by the agent or attorney as indicated below in Item 23',
      type: 'array',
      items: {
        type: 'string',
      },
