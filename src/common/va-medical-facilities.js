module.exports = {
  ...
  AS: [{ value: '459GF', label: 'FALEOMAVAEGA HUNKIN VA CLINIC' }],
  AZ: [
    { value: '649GD', label: 'ANTHEM CBOC' },
    { value: '678GC', label: 'CASA GRANDE CBOC' },
    { value: '678QA', label: 'COCHISE COUNTY VA CLINIC' },
    ...
    { value: '644GH', label: 'PHOENIX MIDTOWN VA CLINIC' },
    { value: '644', label: 'PHOENIX VAMC' },
    { value: '678QB', label: 'PINAL COUNTY VA CLINIC' },
  ...
  CA: [
    ...
    { value: '612QD', label: 'HOWE ROAD VA CLINIC' },
    ...
    { value: '612GF', label: 'MARTINEZ VA MEDICAL CENTER' },
    ...
    { value: '600GD', label: 'SANTA FE SPRINGS VA CLINIC' },
  ...
  CO: [
    ...
    { value: '575QC', label: 'GRAND JUNCTION VA MOBILE CLIN' },
    ...
    { value: '442GD', label: 'LOVELAND VA CLINIC' },
    { value: '575GA', label: 'MONTROSE CBOC' },
    { value: '554GD', label: 'PFC JAMES DUNN VA CLINIC' },
    { value: '554', label: 'ROCKY MOUNTAIN REGIONAL VAMC' },
  ],
  CT: [
  ...
  FL: [
    ...
    { value: '573QK', label: 'LAKE CITY VA CLINIC' },
    ...
    { value: '520QA', label: 'PANAMA CITY BEACH WEST VA CLIN' },
  ...
  GA: [
    ...
    { value: '573GA', label: 'VALDOSTA VA CLINIC' },
  ...
  IA: [
    { value: '636GX', label: 'FORT DODGE NORTH VA CLINIC' },
  ...
  ID: [
    ...
    { value: '660GA', label: 'POCATELLO VA CLINIC' },
  ...
  IL: [
    ...
    { value: '550GF', label: 'MATTOON VA CLINIC' },
    ...
    { value: '657GA', label: 'ST. CLAIR CNTY VA CLINIC' },
  ],
  IN: [
    ...
    { value: '583QD', label: 'INDIANAPOLIS YMCA VA CLINIC' },
    ...
    { value: '583GG', label: 'SHELBYVILLE VA CLINIC' },
  ...
  KS: [
    ...
    { value: '589JC', label: 'JOHNSON COUNTY VA CLINIC' },
  ...
  LA: [
    ...
    { value: '629', label: 'NEW ORLEANS VAMC' },
  ...
  MA: [
    ...
    { value: '631QB', label: 'LAKE AVENUE VA CLINIC' },
  ...
  MD: [
    ...
    { value: '512GD', label: 'LOCH RAVEN VAMC' },
    { value: '460HM', label: 'MILLINTON MORC' },
    { value: '688GF', label: 'MONTGOMERY COUNTY VA CLINIC' },
  ...
  MN: [
    ...
    { value: '618QB', label: 'ELY VA CLINIC' },
    { value: '437GC', label: 'FERGUS FALLS' },
    { value: '618GB', label: 'HIBBING (CBOC)' },
    { value: '618GN', label: 'LYLE C PEARSON CBOC' },
  ...
  MS: [
    ...
    { value: '614GC', label: 'HOLLY SPRINGS VA CLINIC' },
    { value: '586GA', label: 'KOSCIUSKO VA CLINIC' },
    { value: '586QC', label: 'LAKELAND DRIVE VA CLINIC' },
  ...
  NC: [
    ...
    { value: '565QC', label: 'FAYETTEVILLE 2 MOBILE CLINIC' },
    ...
    { value: '565GM', label: 'JACKSONVILLE 3 VA CLINIC' },
    ...
    { value: '565QD', label: 'RAEFORD ROAD VA CLINIC' },
  ...
  ND: [
    ...
    { value: '437GJ', label: 'DICKINSON VA CLINIC' },
    { value: '437', label: 'FARGO VA HCS' },
    { value: '437GA', label: 'GRAFTON VA CLINIC' },
    { value: '437GI', label: 'GRAND FORKS CBOC' },
    { value: '437GK', label: 'JAMESTOWN VA CLINIC' },
  ...
  NJ: [
    ...
    { value: '561GK', label: 'SUSSEX VA CLINIC' },
  ...
  NV: [
    ...
    { value: '593GH', label: 'JESSE DEAN VA CLINIC' },
    ...
    { value: '654QD', label: 'VIRGINIA STREET VA CLINIC' },
    { value: '593QC', label: 'WEST CHEYENNE VA CLINIC' },
  ],
  NY: [
  ...
  OK: [
    ...
    { value: '635QC', label: 'FOURTEENTH STREET VA CLINIC' },
    { value: '564GE', label: 'JAY CBOC' },
    {
      value: '635GA',
      label: 'LAWTON/FT. SILL VA OUTPATIENT CLINIC',
    },
    { value: '623GA', label: 'MCALESTER VA CLINIC' },
  ...
  OR: [
    ...
    { value: '648GJ', label: 'LOREN R KAUFMAN VA CLINIC' },
  ...
  PA: [
    { value: '529', label: 'ABIE ABRAHAM VA CLINIC' },
    ...
    { value: '595GA', label: 'CUMBERLAND COUNTY VA CLINIC' },
    { value: '542GA', label: 'DELAWARE COUNTY VA CLINIC' },
    ...
    { value: '595GF', label: 'SCHUYLKILL COUNTY VA CLINIC' },
  ...
  PR: [
    ...
    { value: '672B0', label: 'PONCE OPC' },
    { value: '672', label: 'SAN JUAN VA MEDICAL CENTER' },
  ],
  RI: [
    { value: '650QB', label: 'EAGLE STREET VA CLINIC' },
  ...
  SD: [
    ...
    { value: '568HK', label: 'MCLAUGHLIN VA CLINIC' },
  ...
  TN: [
    ...
    { value: '621GI', label: 'DANNIE A. CARR VETERANS OPC' },
    { value: '626GA', label: 'DOVER VA CLINIC' },
    { value: '621QE', label: 'DOWNTOWN WEST VA CLINIC' },
    { value: '614GI', label: 'DYERSBURG VA CLINIC' },
    { value: '626GO', label: 'INTERNATIONAL PLAZA VA CLINIC' },
    ...
    { value: '614GF', label: 'NONCONNAH BOULEVARD VA CLINIC' },
    ...
    { value: '626', label: 'TENNESSEE VALLEY HCS' },
    {
      value: '626GG',
  ...
  TX: [
    ...
    { value: '504GA', label: 'CHILDRESS VA CLINIC' },
    {
      value: '671GI',
    ...
    { value: '549GM', label: 'GRAND PRAIRIE VA CLINIC' },
  ...
  UT: [
    ...
    { value: '660QC', label: 'WEBER COUNTY VA CLINIC' },
  ...
  WY: [
    ...
    { value: '666GD', label: 'CODY VA CLINIC' },
