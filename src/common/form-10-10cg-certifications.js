const form1010cgCertificationsWithoutIdProperty = {
  'information-is-correct-and-true': {
    ...
    availableFor: ['veteran', 'primaryCaregiver', 'secondaryCaregiverOne', 'secondaryCaregiverTwo'],
  },
  'consent-to-caregivers-to-perform-care': {
    ...
    availableFor: ['veteran'],
  },
  'at-least-18-years-of-age': {
    text: 'I certify that I am at least 18 years of age.',
    availableFor: ['primaryCaregiver', 'secondaryCaregiverOne', 'secondaryCaregiverTwo'],
  },
  ...
  'currently-or-will-reside-with-veteran--as-primary': {
    text:
      "I reside with the Veteran full-time or will do so upon designation as the Veteran's Primary Family Caregiver.",
    availableFor: ['primaryCaregiver'],
  },
  'currently-or-will-reside-with-veteran--as-secondary': {
    text:
      "I reside with the Veteran full-time or will do so upon designation as the Veteran's Secondary Family Caregiver.",
    availableFor: ['secondaryCaregiverOne', 'secondaryCaregiverTwo'],
  },
